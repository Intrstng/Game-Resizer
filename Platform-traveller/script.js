...
/* harmony import */ var _js_Login__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js/Login */ "./src/js/Login.js");
...
_js_Login__WEBPACK_IMPORTED_MODULE_7__.logInApp.init('app', 'firstStart');
let level = 1,
  canvas,
  c,
  platforms = [],
    ...
    row.forEach((cell, index_X) => {
      switch (cell) {
        ...
        case 'sl':
          ...
          // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
          index_X * 36, index_Y * 36, (0,_Utils__WEBPACK_IMPORTED_MODULE_4__.createImage)(_Assets__WEBPACK_IMPORTED_MODULE_3__.platformSolid, 36, 36), platforms, levelMap.margin.left, levelMap.margin.top));
          break;
        case 'ja':

/******/(() => {
  ...
  var __webpack_modules__ = {
    ...
    (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      ;
      (function () {
        if (_js_data_Audio__WEBPACK_IMPORTED_MODULE_5__.audio.isCanPlay.canPlayType('audio/mpeg') === 'probably') {
          source = 'src_MP3';
        } else {
          source = 'src_OGG';
        }
        for (let sound in _js_data_Audio__WEBPACK_IMPORTED_MODULE_5__.audio) {
          if (_js_data_Audio__WEBPACK_IMPORTED_MODULE_5__.audio?.[sound]?.[source]) {
            let {
              src_MP3: mp3,
              src_OGG: ogg
            } = _js_data_Audio__WEBPACK_IMPORTED_MODULE_5__.audio[sound];
            mp3.play();
            mp3.pause();
            ogg.play();
            ogg.pause();
      ...
      function setVolumeRangeHandlers() {
        ...
        if (volumeRangeSound || volumeRangeMusic) {
          volumeRangeSound.addEventListener('change', () => {
            for (let sound in _js_data_Audio__WEBPACK_IMPORTED_MODULE_5__.audio) {
              if (_js_data_Audio__WEBPACK_IMPORTED_MODULE_5__.audio?.[sound]?.[source] && sound != 'track_1' && sound != 'track_2' && sound != 'track_3' && sound != 'track_4') {
                _js_data_Audio__WEBPACK_IMPORTED_MODULE_5__.audio[sound][source].volume = volumeRangeSound.value;
              }
            }
          ...
          volumeRangeMusic.addEventListener('change', () => {
            for (let sound in _js_data_Audio__WEBPACK_IMPORTED_MODULE_5__.audio) {
              if (_js_data_Audio__WEBPACK_IMPORTED_MODULE_5__.audio?.[sound]?.[source] && (sound === 'track_1' || sound === 'track_2' || sound === 'track_3' || sound === 'track_4')) {
                _js_data_Audio__WEBPACK_IMPORTED_MODULE_5__.audio[sound][source].volume = volumeRangeMusic.value;
              }
            }
            setLocalStorage(volumeRangeSound.value, volumeRangeMusic.value);
          });
            ...
            <h2 class="settings__title">Audio settings:</h2>
              <div class="settings__slider-box">
                ...
                <input type="range" id="volume-snd" class="settings__slider settings__slider_hover" name="volume-sounds"
                  min="0" max="1" value="${(0, _index__WEBPACK_IMPORTED_MODULE_1__.getLocalStorage)('settings', 'soundEffects')}" step="0.1">   
                    ...
                    <input type="range" id="volume-msc" class="settings__slider settings__slider_hover" name="volume-music" 
                      min="0" max="1" value="${(0, _index__WEBPACK_IMPORTED_MODULE_1__.getLocalStorage)('settings', 'musicEffects')}" step="0.1">
              </div>
          </section>
        `;
            }
    ...
    /***/
    () => {
      throw new Error("Module build failed (from ./node_modules/babel-loader/lib/index.js):\nSyntaxError: C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\src\\js\\data\\Audio.js: Identifier 'source' has already been declared. (164:4)\n\n\u001b[0m \u001b[90m 162 |\u001b[39m }\u001b[0m\n\u001b[0m \u001b[90m 163 |\u001b[39m\u001b[0m\n\u001b[0m\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 164 |\u001b[39m \u001b[36mlet\u001b[39m source \u001b[33m=\u001b[39m \u001b[36mnull\u001b[39m\u001b[33m;\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m     |\u001b[39m     \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m 165 |\u001b[39m  \u001b[90m// Choose supported source and preload\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m 166 |\u001b[39m  \u001b[33m;\u001b[39m(\u001b[36mfunction\u001b[39m() {\u001b[0m\n\u001b[0m \u001b[90m 167 |\u001b[39m   \u001b[36mif\u001b[39m (audio\u001b[33m.\u001b[39misCanPlay\u001b[33m.\u001b[39mcanPlayType(\u001b[32m'audio/mpeg'\u001b[39m) \u001b[33m===\u001b[39m \u001b[32m'probably'\u001b[39m) {\u001b[0m\n    at instantiate (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:653:32)\n    at constructor (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:946:12)\n    at Parser.raise (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:3270:19)\n    at ScopeHandler.checkRedeclarationInScope (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:1556:19)\n    at ScopeHandler.declareName (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:1527:12)\n    at Parser.declareNameFromIdentifier (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:7544:16)\n    at Parser.checkIdentifier (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:7540:12)\n    at Parser.checkLVal (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:7479:12)\n    at Parser.parseVarId (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:13214:10)\n    at Parser.parseVar (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:13192:12)\n    at Parser.parseVarStatement (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:13032:10)\n    at Parser.parseStatementContent (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:12629:23)\n    at Parser.parseStatementLike (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:12549:17)\n    at Parser.parseModuleItem (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:12526:17)\n    at Parser.parseBlockOrModuleBlockBody (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:13121:36)\n    at Parser.parseBlockBody (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:13114:10)\n    at Parser.parseProgram (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:12437:10)\n    at Parser.parseTopLevel (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:12427:25)\n    at Parser.parse (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:14245:10)\n    at parse (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\parser\\lib\\index.js:14286:38)\n    at parser (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\core\\lib\\parser\\index.js:41:34)\n    at parser.next (<anonymous>)\n    at normalizeFile (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\core\\lib\\transformation\\normalize-file.js:64:38)\n    at normalizeFile.next (<anonymous>)\n    at run (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\core\\lib\\transformation\\index.js:21:50)\n    at run.next (<anonymous>)\n    at transform (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\@babel\\core\\lib\\transform.js:22:41)\n    at transform.next (<anonymous>)\n    at step (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\gensync\\index.js:261:32)\n    at C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\gensync\\index.js:273:13\n    at async.call.result.err.err (C:\\Users\\User\\Desktop\\31.0 Add music level range change\\Game\\node_modules\\gensync\\index.js:223:11)");

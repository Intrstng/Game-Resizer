/******/(() => {
  ...
  var __webpack_modules__ = {
    ...
    (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      class Flamethrower {
        constructor(posX, posY, images, platforms, bulletController) {
          this.x = posX;
          this.y = posY;

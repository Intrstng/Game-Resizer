    ...
    (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      class Flamethrower {
        constructor(posX, posY, image, platforms, bulletController) {
          ...
          this.sprites = {
            idle: (0, _CreateImage__WEBPACK_IMPORTED_MODULE_2__.createImage)(_Assets__WEBPACK_IMPORTED_MODULE_4__.flamethrowerLeft, 36, 36)
          };
          this.currentSprite = this.sprites.idle;
        ...
        draw() {
          ...
          _Canvas__WEBPACK_IMPORTED_MODULE_0__.c.strokeRect(this.position.x, this.position.y, this.width, this.height);
          _Canvas__WEBPACK_IMPORTED_MODULE_0__.c.fillStyle = "black";
          _Canvas__WEBPACK_IMPORTED_MODULE_0__.c.fillRect(this.position.x, this.position.y, this.width, this.height);
          //c.drawImage(this.currentSprite, 32 * this.frames, 0, 32, 32, this.left, this.top, this.width, this.height)
          this.shoot();
      ...
      class BulletController {
        ...
        shoot(posX, posY, speed, delay) {
          if (this.timerTillNextBullet <= 0) {
            this.bullets.push(new Bullet(posX, posY, speed));

/******/(() => {
  ...
  var __webpack_modules__ = {
    ...
    (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      /* harmony import */
      var _js_data_DescriptionForLevelMap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__( /*! ./js/data/DescriptionForLevelMap */"./src/js/data/DescriptionForLevelMap.js");
      /* harmony import */
      ...
      let platforms = [],
        parsedCollisions,
        player;
      (0, _js_Levels__WEBPACK_IMPORTED_MODULE_12__.requestLevelMap)(`/src/js/json/levelMap_${level}.json`, _js_Collision__WEBPACK_IMPORTED_MODULE_1__.parseCollisitions, createPlayer, init, animate);
      ...
      function reloadGameplay() {
        ...
        _js_data_DescriptionForLevelMap__WEBPACK_IMPORTED_MODULE_5__.levelMap[level].map.forEach((row, index_Y) => {
          row.forEach((cell, index_X) => {
            cell === 'st' && (player = new _js_Player__WEBPACK_IMPORTED_MODULE_4__.Player({
              platforms
            }, index_X * 36, index_Y * 36, _js_data_DescriptionForLevelMap__WEBPACK_IMPORTED_MODULE_5__.levelMap[level].margin.left, _js_data_DescriptionForLevelMap__WEBPACK_IMPORTED_MODULE_5__.levelMap[level].margin.top));
          });
        });
      }
    ...
    (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      /* harmony import */
      var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! ../index */"./src/index.js");
      function requestLevelMap(url, callback_1, callback_2, callback_3, callback_4) {
        fetch(url).then(response => {
          if (response.status !== 200) {
            console.log(`Возникла проблема. Код ошибки: ${response.status}`);
            return;
          }
          response.json().then(data => callback_1(data, _index__WEBPACK_IMPORTED_MODULE_0__.platforms)).then(player => callback_2(player, _index__WEBPACK_IMPORTED_MODULE_0__.platforms)).then(init => callback_3(init, _index__WEBPACK_IMPORTED_MODULE_0__.platforms)).then(animate => callback_4(animate, _index__WEBPACK_IMPORTED_MODULE_0__.platforms)).catch(err => console.error('Fetch Error - levels map load failed', err));
        });
      }
    ...
    /***/"./src/js/data/DescriptionForLevelMap.js":
    /*!***********************************************!*\
      !*** ./src/js/data/DescriptionForLevelMap.js ***!
      \***********************************************/
    /***/
